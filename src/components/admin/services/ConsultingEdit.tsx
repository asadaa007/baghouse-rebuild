...
const ConsultingEdit = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      if (data && data.consulting) {
        setCategoryData(data.consulting);
      }
    };
    loadData();
  }, []);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (fullData) {
        // Update only the consulting category
        const updatedData: ServicesContentData = {
          ...fullData,
          consulting: categoryData
        };
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Edit Consulting</h1>
            <p className="text-gray-600 mt-1">Manage content for the Consulting page</p>
          </div>
