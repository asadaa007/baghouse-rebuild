...
const SheetMetalDuctingEdit = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      if (data && data.sheetMetalDucting) {
        setCategoryData(data.sheetMetalDucting);
      }
    };
    loadData();
  }, []);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (fullData) {
        // Update only the sheet metal ducting category
        const updatedData: ServicesContentData = {
          ...fullData,
          sheetMetalDucting: categoryData
        };
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Edit Sheet Metal & Ducting</h1>
            <p className="text-gray-600 mt-1">Manage content for the Sheet Metal & Ducting page</p>
          </div>
...
export default SheetMetalDuctingEdit;
