...
const BaghouseFieldServicesEdit = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      if (data && data.baghouseFieldServices) {
        setCategoryData(data.baghouseFieldServices);
      }
    };
    loadData();
  }, []);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (fullData) {
        // Update only the baghouse field services category
        const updatedData: ServicesContentData = {
          ...fullData,
          baghouseFieldServices: categoryData
        };
  ...
  const handleExperienceChange = (field: keyof NonNullable<ServiceCategory['experience']>, value: string) => {
    setCategoryData(prev => ({
      ...prev,
      experience: {
        ...prev.experience!,
  ...
  const handleFeatureChange = (index: number, value: string) => {
    setCategoryData(prev => ({
      ...
      experience: {
        ...prev.experience!,
        features: prev.experience!.features.map((feature, i) => 
  ...
  const addFeature = () => {
    setCategoryData(prev => ({
      ...
      experience: {
        ...prev.experience!,
        features: [...prev.experience!.features, '']
      }
    }));
  };
  ...
  const removeFeature = (index: number) => {
    setCategoryData(prev => ({
      ...
      experience: {
        ...prev.experience!,
        features: prev.experience!.features.filter((_, i) => i !== index)
      }
    }));
  };
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Edit Baghouse Field Services</h1>
            <p className="text-gray-600 mt-1">Manage content for the Baghouse Field Services page</p>
          </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg">
        ...
        <div className="p-6">
          ...
          {/* Experience Tab */}
          {activeTab === 'experience' && categoryData.experience && (
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                <h3 className="text-lg font-medium text-gray-900">Experience Section</h3>
                <button
                  onClick={addFeature}
                  className="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors"
                >
              ...
              <div className="grid grid-cols-1 gap-6">
                <div>
                  ...
                  <input
                    type="text"
                    value={categoryData.experience.title}
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={categoryData.experience.subtitle}
                    onChange={(e) => handleExperienceChange('subtitle', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div>
                  ...
                  <textarea
                    value={categoryData.experience.description}
              ...
              <div className="space-y-4">
                ...
                {categoryData.experience.features.map((feature, index) => (
...
export default BaghouseFieldServicesEdit;
