              ...
              <div className="relative h-80 overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-8">
                  <div className="transform group-hover:translate-y-0 translate-y-2 transition-transform duration-500">
                    ...
                    <div className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 opacity-0 group-hover:opacity-100 group-hover:translate-y-0 translate-y-4 inline-block">
                      Learn More
                    </div>
                  </div>
                </div>
