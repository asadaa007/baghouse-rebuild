...
const SpareParts = () => {
  ...
  const loadServicesData = async () => {
    try {
      ...
      if (data?.spareParts) {
        const category = data.spareParts;
        ...
        if (category.qualityAssurance) {
          setQualityAssuranceData(category.qualityAssurance);
        }
      }
    } catch (error) {
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {qualityAssuranceData.features.map((feature, index) => (
                  ...
                  <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl p-8 text-white">
                    <div className="text-center">
                      ...
                      <p className="text-blue-100 leading-relaxed">
                        We partner with leading manufacturers to provide high-quality spare parts that meet or exceed OEM specifications. Our commitment to quality ensures your baghouse systems operate at peak performance.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 leading-relaxed">
              Contact us today to discuss your spare parts needs. Our experienced team is ready to help you find the right components for your baghouse systems.
            </p>
