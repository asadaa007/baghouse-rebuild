...
const SheetMetalDucting = () => {
  ...
  const loadServicesData = async () => {
    try {
      ...
      if (data?.sheetMetalDucting) {
        const category = data.sheetMetalDucting;
      ...
      console.error('Error loading sheet metal ducting data:', error);
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 leading-relaxed">
              Contact us today to discuss your sheet metal and ducting needs. Our experienced team is ready to help you design, fabricate, and install your dust collection systems.
            </p>
